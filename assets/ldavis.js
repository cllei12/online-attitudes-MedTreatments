...
var LDAvis = function(to_select, data_or_file_name, color1, color2) {
    ...
    function visualize(data) {
        ...
        function init_forms(topicID, lambdaID, visID) {
            ...
            topicDiv.setAttribute("style", "padding: 5px; background-color: #e8e8e8; display: inline-block; width: " + (mdswidth+75) + "px; height: 50px; float: left");
